...
function Contact() {
    return (
        <section id="contact" className="relative text-black dark:text-white dark:bg-dark">
        <div className="container px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap">
          ...
          method="POST"
            ...
            <button
              type="submit"
              className="text-white bg-blue border-0 py-2 px-6 focus:outline-none hover:bg-blue-dark rounded text-lg">
              Submit
            </button>
          </form>
        </div>
